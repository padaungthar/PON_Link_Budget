...
| --- | --- | --- |
| Fiber Loss | 0.35 dB/km (at 1310 nm)
              0.25 dB/km (at 1490 nm) | Depends on fiber type and wavelength |
...
## 📊 Rule of Thumb
  ...
  If you're close to the limit, consider C+ optics or reducing splitter ratio.
